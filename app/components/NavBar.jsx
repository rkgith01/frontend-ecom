            ...
            <div className="flex items-center gap-4">
              ...
              <div className='flex gap-4 '>
                   ...
                   <div className="relative mx-auto">
                    ...
                    >
                      <input
                        type="search"
                        value={searchItem}
                        onChange={(e) => setSearchItem(e.target.value) && focus(e)}
                        placeholder="Search..."
                          ...
                          <div className="relative mx-auto w-full sm:w-3/4 md:w-2/3 lg:w-1/2 xl:w-1/3 bg-white p-4 rounded-lg overflow-y-auto">
                            ...
                            <div className="grid grid-cols-2 gap-4 md:grid-cols-2 lg:grid-cols-3">
                              {filteredData.length > 0 ? ( 
                                ...
                                <p className='text-gray-500 items-center text-center'>No results found</p>
                              )}
                            </div>
                          </div>
                        </div>
                ...
                {/* <User2Icon/> */}
                 ...
                 {/* Cart Button */}
                 <div className='flex cursor-pointer ' onClick={() => setOpen(!open) && setShowSearchInput(!showSearchInput) }>
                <ShoppingCartIcon size={24} />
                
                {products.length > 0 && 
                <>
                <Circle size={24} color='blue' className='relative bottom-2 right-2' fill='blue' />
                <span className='text-[14px] relative bottom-[0.4rem] right-[24px]   mr-0'>{products.length}</span>                
                </>
}
              </div>
