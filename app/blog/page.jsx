  ...
  return (
    <div>
        ...
        <div className="md:w-1/2 p-8">
            <h1 className="text-3xl font-bold mb-4">LuxueLease - Elevate Your Style, Effortlessly</h1>
            <p className="text-gray-600 mb-6">
            Welcome to LuxueLease, where luxury meets accessibility. We redefine fashion by offering you the
            opportunity to adorn high-end styles for any occasion, without the heavy price tag.
            </p>
            ...
            <ul className="list-disc pl-6">
                ...
                <li>Subscribe for regular wardrobe updates and exclusive perks.</li>
            </ul>
            </div>
            ...
            {/* Contact Information */}
            <div>
            <p className="text-gray-600">Questions? Contact us at support@email.com or phone number.</p>
            </div>
        </div>
        </div>
    </div>
