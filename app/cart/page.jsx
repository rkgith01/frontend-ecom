"use client"
import { ArrowRight, ArrowRightCircle, Loader, ShoppingBasket, TicketPercent, Trash2 } from 'lucide-react'
            ...
            {products.length > 0 ? (
                <div className="mx-auto max-w-3xl">
                    <header className="text-center">
                        <h1 className="text-xl font-bold text-gray-400 sm:text-3xl">Your Cart</h1>
                    </header>
                    ...
                    {products.map((item) => (
                        ...
                        <li className="flex items-center gap-4" key={item.id}>
                            ...
                            <div>
                                ...
                                <dl className="mt-0.5 space-y-px text-[10px] text-gray-500">
                                    ...
                                    <dd className="inline text-wrap text-sm line-clamp-3">{(item.desc).substring(0, 35)}...</dd>
                                    </div>
                                ...
                                <dl className="mt-0.5 space-y-px text-[10px] text-gray-500">
                                    <div>
                                    <dt className="inline text-lg text-blue-400  mr-1">{item.quantity} :</dt> 
                                    <dd className="inline text-lg text-blue-400">${item.price}</dd>
                                    </div>
                        ...
                        <div className="w-screen max-w-lg space-y-4">
                            ...
                            <div className="flex  justify-end">
                                ...
                                >
                                Checkout  {loading ? <Loader className='animate-spin text-white' size={22}/> : <ArrowRightCircle className='animate-pulse text-white' size={22}/>
                                }      
                                </button>
                            </div>
                        </div>
                ...
                <div className="mx-auto max-w-3xl h-screen flex items-center justify-center"> 
                    ...
                    <div className="flex flex-col gap-4">
                        <h1 className="text-2xl font-mono mb-3 text-center italic text-wrap line-clamp-2">No products left, Your cart is empty..!</h1>
                        
                        <ShoppingBasket size={145} className='mx-auto animate-bounce mt-2'/>

                        <Link href="/" className='rounded flex  justify-center bg-slate-500 px-4 py-2 text-white text-center mt-4'>Continue Shopping <ArrowRight size={24} className='animate-pulse' /></Link>
                    </div>
